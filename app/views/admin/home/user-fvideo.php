                                                                                     ...
                                                                                     <?php foreach ($data['getVideo'] as $video) : ?>
                                                                                         <?php if ($video['ekstensi'] == 'mp4') : ?>
                                                                                             <tr>
                                                                                                 ...
                                                                                                 <td>
                                                                                                     <a class="border-0 play" href="" data-toggle="modal" data-target=".modalplay" data-caption="<?= $video['info']; ?>" data-video="<?= BASEURL; ?>/media/<?= $data['userid']['nama']; ?>/<?= $data['folderinfo']['namaFolder'] ?>/<?= $video['nama'] ?>"><i class="icon-video text-success mr-1"></i><?= $video['info']; ?>
                                                                                                     </a>
                                                                                                 </td>
