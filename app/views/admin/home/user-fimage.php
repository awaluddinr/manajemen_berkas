                                                                                             ...
                                                                                             <?php if ($image['ekstensi'] == 'jpg') : ?>
                                                                                                 <tr>
                                                                                                     ...
                                                                                                     <td class="text-center">
                                                                                                         <a class="border-0 mb-0" href="<?= BASEURL; ?>/media/<?= $data['userid']['nama']; ?>/<?= $data['folderinfo']['namaFolder']; ?>/<?= $image['nama'] ?>" data-caption="<?= $image['info']; ?>"><i class="icon-image text-primary mr-1"></i><?= $image['info']; ?>
                                                                                                         </a>
                                                                                                     </td>
