        ...
        <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
            <div class="card h-100">
                <div class="card-header">
                    <div class="card-title">Update Profile <i class="icon-chevron-right1"></i>
                        <font class="text-primary"><?= $data['userid']['info']; ?></font>
                    </div>
                </div>
                <div class="card-body">
                    <div class="account-settings">
                        <div class="user-profile">
                            <form action="<?= URL; ?>/Home/editUser/" method="POST" enctype="multipart/form-data">
                                <div class="user-avatar">
                                    <div class="mb-0">
                                        <img src="<?= BASEURL; ?>/media/img/<?= $data['userid']['gambar']; ?>" alt="Le Rouge Admin" id="chosen-image" />
                                        <figcaption id="file-name"></figcaption>
                                    </div>
                                    <div class="form-group text-center">
                                        <input type="file" name="img" id="upload-button" accept=".jpg,.png">
                                        <label class="uploadbtn" for="upload-button">
                                            <i class="icon-add"></i> &nbsp; Pilih Gambar
                                        </label>
                                    </div>
                                </div>
                                <input type="hidden" class="form-control" name="userid" value="<?= $data['userid']['id']; ?>">
                                <input type="hidden" name="imglama" value="<?= $data['userid']['gambar']; ?>">
                                <div class="col-xl-11 px-0">
                                    <div class="mb-0">
                                        <div class="form-group text-left">
                                            <label for="akun">Nama Akun</label>
                                            <input type="text" class="form-control" name="akun" id="akun" value="<?= $data['userid']['username']; ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-11 px-0">
                                    <div class="form-group text-left">
                                        ...
                                        <input type="text" class="form-control" name="info" id="nama" value="<?= $data['userid']['info']; ?>">
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    <div class="row gutters">
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6 col-12">
                            <form action="<?= URL; ?>/Home/ubahUserpass/" method="post">
                                <input type="hidden" class="form-control" name="userid" value="<?= $data['userid']['id']; ?>">
...
<div class="modal modalsuksesUbahPass animate__animated" data-animate-in='animate__bounceIn' tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="mb-0 py-2">
            </div>
            <div class="modal-body text-center">
                <i class="icon-check_circle text-success d-block mb-3" style="font-size: 50px;"></i>
                <h3 class="mb-2">Sukses</h3>
                <h5>Password User Berhasil DiUbah</h5>
            </div>
            <div class="modal-footer justify-content-center" style="padding: .5rem;">
                <button type="button" class="btn btn-primary px-5" data-dismiss="modal">OK</button>
            </div>
